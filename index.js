...
const storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        cb(null , req.session.ID.toString() + "-" + "nbrImage" + ".jpg");
    }
});
...
app.use(bodyParser.json());
let db = require("./db")
const {updateorder,deleteproduct, getID, getMoney,getProduct} = require("./db");
...
app.post("/Commandes",upload.single("image"),async (req,res)=>{
